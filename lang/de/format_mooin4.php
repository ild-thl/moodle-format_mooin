...
$string['certificate_overview_description'] = 'Herzlichen Glückwunsch! Du hast die im Kurs enthaltenen Selbtsttests erfolgreich bearbeitet. Hier kannst du die deine Teilnahmebestätigung herunterladen.';
...
$string['discussion'] = 'Letzter Beitrag';
...
$string['hint_track_forums'] = 'Bitte aktualisiere deine Forum-Einstellungen <a href="{$a->wwwroot}/user/forum.php?id={$a->userid}&course=1">hier</a>, damit neue Beiträge markiert werden (Forumstracking > Ja, neue Beiträge farblich markieren).';
...
$string['pluginname'] = 'Mooin 4.x Kursformat';
...
$string['toggle_global_participant_list_for_students'] = 'Teilnehmerliste und Karte für Teilnehmer global freischalten';
$string['toggle_participant_list_for_students'] = 'Teilnehmerliste und Karte für Teilnehmer anzeigen';
$string['toggle_participant_list_for_students_help'] = 'Wenn aktiviert, sehen Teilnehmer die volle Teilnehmerliste und Karte auf der Teilnehmerseite sowie die Namensliste in der Community-Kachel.';
