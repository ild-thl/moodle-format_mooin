...
$string['no_badges_available'] = '<h2>There are no badges available in this course yet</h2>';
...
$string['certificate_overview_description'] = '<h5>Congratulations! You have successfully completed the tests included in the course. You can download your certificate of participation here.</h5>';
