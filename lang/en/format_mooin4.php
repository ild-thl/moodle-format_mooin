...
$string['pluginname'] = 'Mooin 4.x course format';
...
$string['toggle_global_participant_list_for_students'] = 'Enable participant list and map for students globally';
$string['toggle_participant_list_for_students'] = 'Show participant list and map for students';
$string['toggle_participant_list_for_students_help'] = 'When enabled, students see the full participant list and map on the participants page, and the name list in the community tile.';
