...
/**
 * mooin course format related unit tests.
 *
 * @package    format_mooin
 * @copyright  2022 ISy TH Lübeck <dev.ild@th-luebeck.de>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class format_mooin_test extends \advanced_testcase {

    /**
     * Tests for format_mooin::get_section_name method with default section names.
     *
     * @return void
     */
    public function test_get_section_name() {
        ...
        $numsections = 5;
        $course = $generator->create_course(['numsections' => $numsections, 'format' => 'mooin'],
            ['createsections' => true]);
    ...
    /**
     * Tests for format_mooin::get_section_name method with modified section names.
     *
     * @return void
     */
    ...
    /**
     * Tests for format_mooin::get_default_section_name.
     *
     * @return void
     */
    public function test_get_default_section_name() {
        ...
        foreach ($coursesections as $section) {
            if ($section->section == 0) {
                $sectionname = get_string('section0name', 'format_mooin');
                $this->assertEquals($sectionname, $courseformat->get_default_section_name($section));
            } else {
                $sectionname = get_string('sectionname', 'format_mooin') . ' ' . $section->section;
                $this->assertEquals($sectionname, $courseformat->get_default_section_name($section));
            }
        }
    }
    ...
    public function test_update_inplace_editable() {
        ...
        $this->setUser($user);
        $course = $this->getDataGenerator()->create_course(['numsections' => 5, 'format' => 'mooin'],
            ['createsections' => true]);
        $section = $DB->get_record('course_sections', ['course' => $course->id, 'section' => 2]);

        // Call webservice without necessary permissions.
        try {
            \core_external::update_inplace_editable('format_mooin', 'sectionname', $section->id, 'New section name');
        ...
        $res = \core_external::update_inplace_editable('format_mooin', 'sectionname', $section->id, 'New section name');
    ...
    public function test_inplace_editable() {
        ...
        // Call callback format_mooin_inplace_editable() directly.
        $tmpl = component_callback('format_mooin', 'inplace_editable', ['sectionname', $section->id, 'Rename me again']);
    ...
    public function test_default_course_enddate() {
        ...
        $params = ['format' => 'mooin', 'numsections' => 5, 'startdate' => 1445644800];
    ...
    public function test_get_view_url() {
        ...
        $generator = $this->getDataGenerator();
        $course1 = $generator->create_course(['format' => 'mooin']);
