...
class edit_header_form extends \moodleform {
    public function definition() {
        ...
        $mform->addElement('filemanager', 'headerimagedesktop', get_string('headerimagedesktop', 'format_moointopics'), null, $filemanageropts);
        $mform->addElement('filemanager', 'headerimagemobile', get_string('headerimagemobile', 'format_moointopics'), null, $filemanageropts);
